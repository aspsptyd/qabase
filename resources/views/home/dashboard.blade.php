            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Homepage Quality Assurance</h1>
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Export Report Homepage</a>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Fluktuasi Proses Testing <label style="color: rgb(255, 255, 255); background-color:rgb(0, 76, 255); padding:2px; border-radius: 3px; font-size:13px; font-weight:bold; height:18px; width:45px; text-align:center">2023</label></h6>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Persentase Bug / Issue Tracking</h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-danger"></i> Bug
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-warning"></i> Issue
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Solved
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Progress Testing by Project</h6>
                                </div>
                                <div class="card-body">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; 2023 Quality Assurance. All right reserved</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
